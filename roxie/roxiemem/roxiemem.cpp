...
public:
    ...
    void expandHeap(memsize_t &capacity, void * & original, memsize_t copysize, memsize_t oldcapacity, memsize_t newsize, unsigned activityId, IRowResizeCallback * callback);
...
public:
    ...
    virtual void resizeRow(memsize_t &capacity, void * & ptr, memsize_t copysize, memsize_t newsize, unsigned activityId, IRowResizeCallback * callback)
    {
        ...
        {
            hugeHeap.expandHeap(capacity, ptr, copysize, curCapacity, newsize, activityId, callback);
            return;
        }
...
{
    rowManager->resizeRow(capacity, original, copysize, newsize, allocatorId, NULL);
    return original;
}
...
void CHugeChunkingHeap::expandHeap(memsize_t &capacity, void * & ptr, memsize_t copysize, memsize_t oldcapacity, memsize_t newsize, unsigned activityId, IRowResizeCallback * callback)
{
    void * const original = ptr;
    ...
    void testResizeFragmenting()
    {
        ...
        try
        {
            loop
            {
                ...
                rowManager->resizeRow(capacity, prev, requestSize, nextSize, 1, &callback);
    ...
    void testResizeDoubleFragmenting()
    {
        ...
        try
        {
            loop
            {
                ...
                rowManager->resizeRow(capacity, prev1, requestSize, nextSize, 1, &callback1);
                ASSERT(newSize1 == capacity);
                rowManager->resizeRow(capacity, prev2, requestSize, nextSize, 1, &callback2);
...
protected:
    ...
    void testHuge()
    {
        ...
        rowManager->resizeRow(capacity, huge1, initialAllocSize, hugeAllocSize, 1, NULL);
        ...
        rowManager->resizeRow(capacity, huge1, hugeAllocSize/2, hugeAllocSize, 1, NULL);
        ASSERT(capacity > hugeAllocSize);
        ASSERT(rowManager->numPagesAfterCleanup(true)==4097);
        ReleaseRoxieRow(huge1);
        ASSERT(rowManager->numPagesAfterCleanup(true)==0);
