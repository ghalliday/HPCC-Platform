...
extern jlib_decl bool isCompressedFile(const char *filename, offset_t expectedSize=unknownFileSize);
extern jlib_decl bool isCompressedFile(IFile *file, offset_t expectedSize=unknownFileSize);
extern jlib_decl ICompressedFileIO *createCompressedFileReader(IFile *file,IExpander *expander=NULL, offset_t expectedSize=unknownFileSize, bool memorymapped=false, IFEflags extraFlags=IFEnone);
extern jlib_decl ICompressedFileIO *createCompressedFileReader(IFileIO *fileio,IExpander *expander=NULL, offset_t expectedSize=unknownFileSize);
