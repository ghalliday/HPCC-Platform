...
void CppCompiler::setPrecompileHeader(bool _pch)
{
    if (targetCompiler==Vs6CppCompiler)
        throw MakeStringException(JLIBERR_UtilPrecompiledHeaderGenerationOnlySupportedForG, "precompiled header generation only supported for g++ and compatible compilers");
