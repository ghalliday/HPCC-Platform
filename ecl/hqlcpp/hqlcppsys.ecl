...
const char * cppSystemText[]  = {
    ...
    "   DecPushQString(const data src) :    eclrtl,volatile,library='eclrtl',entrypoint='rtlDecPushQStr';",
    "   DecPushUnicode(const unicode src) : eclrtl,volatile,library='eclrtl',entrypoint='rtlDecPushUnicode';",
    ...
    "   writeInt3(noconst data1 src, unsigned4 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlWriteInt3';",
    "   writeInt5(noconst data1 src, unsigned8 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlWriteInt5';",
    "   writeInt6(noconst data1 src, unsigned8 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlWriteInt6';",
    "   writeInt7(noconst data1 src, unsigned8 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlWriteInt7';",
    ...
    "   setPackedSigned(noconst data1 src, integer8 value) :    eclrtl,volatile,library='eclrtl',entrypoint='rtlSetPackedSigned';",
    "   setPackedUnsigned(noconst data1 src, unsigned8 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlSetPackedUnsigned';",
    ...
    "   DecAbs() :  eclrtl,volatile,library='eclrtl',entrypoint='DecAbs';",
    "   DecAdd() :  eclrtl,volatile,library='eclrtl',entrypoint='DecAdd';",
    ...
    "   integer4 DecCompareNull() : eclrtl,volatile,library='eclrtl',entrypoint='DecCompareNull';",
    "   integer4 DecDistinct() :    eclrtl,volatile,library='eclrtl',entrypoint='DecDistinct';",
    "   integer4 DecDistinctR() :   eclrtl,volatile,library='eclrtl',entrypoint='DecDistinctR';",
    "   DecDivide(unsigned1 dbz) :   eclrtl,volatile,library='eclrtl',entrypoint='DecDivide';",
    "   DecModulus(unsigned1 dbz) :  eclrtl,volatile,library='eclrtl',entrypoint='DecModulus';",
    "   DecSub() :  eclrtl,volatile,library='eclrtl',entrypoint='DecSub';",
    "   DecSubR() : eclrtl,volatile,library='eclrtl',entrypoint='DecSubR';",
    "   DecNegate() :   eclrtl,volatile,library='eclrtl',entrypoint='DecNegate';",
    "   unsigned4 DecPopString(noconst string tgt) :    eclrtl,volatile,library='eclrtl',entrypoint='DecPopString';",
    "   DecPopVString(noconst string tgt) : eclrtl,volatile,library='eclrtl',entrypoint='DecPopCString';",
    "   varstring DecPopVStringX() :    eclrtl,volatile,library='eclrtl',entrypoint='DecPopCStringX';",
    "   integer8 DecPopInt64() :    eclrtl,volatile,library='eclrtl',entrypoint='DecPopInt64';",
    "   DecPopDecimal(noconst data1 tgt,unsigned1 len,unsigned1 prec) : eclrtl,volatile,library='eclrtl',entrypoint='DecPopDecimal';",
    "   DecPopUDecimal(noconst data1 tgt,unsigned1 len,unsigned1 prec) : eclrtl,volatile,library='eclrtl',entrypoint='DecPopUDecimal';",
    "   unsigned4 DecPopUlong() :   eclrtl,volatile,library='eclrtl',entrypoint='DecPopUlong';",
    "   real8 DecPopReal() :    eclrtl,volatile,library='eclrtl',entrypoint='DecPopReal';",
    "   DecPushString(const string tgt) :   eclrtl,volatile,library='eclrtl',entrypoint='DecPushString';",
    "   DecPushCString(const varstring src) :   eclrtl,volatile,library='eclrtl',entrypoint='DecPushCString';",
    "   DecPushInt64(integer8 src) :    eclrtl,volatile,library='eclrtl',entrypoint='DecPushInt64';",
    "   DecPushLong(integer4 src) : eclrtl,volatile,library='eclrtl',entrypoint='DecPushLong';",
    "   DecPushDecimal(const data1 src, unsigned1 declen, unsigned1 prec) : eclrtl,volatile,library='eclrtl',entrypoint='DecPushDecimal';",
    "   DecPushUDecimal(const data1 src, unsigned1 declen, unsigned1 prec) : eclrtl,volatile,library='eclrtl',entrypoint='DecPushUDecimal';",
    "   DecPushUInt64(unsigned8 src) :  eclrtl,volatile,library='eclrtl',entrypoint='DecPushUInt64';",
    "   DecPushULong(unsigned4 src) :   eclrtl,volatile,library='eclrtl',entrypoint='DecPushULong';",
    "   DecRound() :    eclrtl,volatile,library='eclrtl',entrypoint='DecRound';",
    "   DecRoundUp() :  eclrtl,volatile,library='eclrtl',entrypoint='DecRoundUp';",
    "   DecRoundTo(unsigned4 places) :  eclrtl,volatile,library='eclrtl',entrypoint='DecRoundTo';",
    "   DecDup() :  eclrtl,volatile,library='eclrtl',entrypoint='DecDup';",
    "   DecMul() :  eclrtl,volatile,library='eclrtl',entrypoint='DecMul';",
    "   DecDivideR(unsigned1 dbz) :  eclrtl,volatile,library='eclrtl',entrypoint='DecDivideR';",
    "   DecLongPower(integer4 pow) :    eclrtl,volatile,library='eclrtl',entrypoint='DecLongPower';",
    "   DecPushReal(real8 d) :  eclrtl,volatile,library='eclrtl',entrypoint='DecPushReal';",
    "   DecPushUtf8(utf8 d) :   eclrtl,volatile,library='eclrtl',entrypoint='rtlDecPushUtf8';",
    "   DecTruncate() :    eclrtl,volatile,library='eclrtl',entrypoint='DecTruncate';",
    "   DecTruncateAt(unsigned4 places) :  eclrtl,volatile,library='eclrtl',entrypoint='DecTruncateAt';",

    "   DecSetPrecision(unsigned1 len, unsigned1 prec) : eclrtl,volatile,library='eclrtl',entrypoint='DecSetPrecision';",
    "   integer4 DecPopLong() : eclrtl,volatile,library='eclrtl',entrypoint='DecPopLong';",
    "   DecSwap() : eclrtl,volatile,library='eclrtl',entrypoint='DecSwap';",
    "   DecUint4Power(unsigned4 pow) :  eclrtl,volatile,library='eclrtl',entrypoint='DecUint4Power';",
    "   string DecPopStringX() :    eclrtl,volatile,library='eclrtl',entrypoint='DecPopStringX';",
    "   boolean DecValid(boolean isSigned, const data src) : eclrtl,pure,library='eclrtl',entrypoint='DecValid';",
    "   boolean DecValidTos() : eclrtl,volatile,library='eclrtl',entrypoint='DecValidTos';",
    ...
    "   _fail(integer4 code, const varstring msg) : eclrtl,fail,library='eclrtl',entrypoint='rtlFail';",
    "   sysFail(integer4 code, const varstring msg) :   eclrtl,fail,library='eclrtl',entrypoint='rtlSysFail';",
    "   failDivideByZero() : eclrtl,fail,library='eclrtl',entrypoint='rtlFailDivideByZero';",
    ...
    "   hashMd5Init(noconst data _state) :  eclrtl,volatile,entrypoint='rtlHashMd5Init';",
    "   hashMd5Data(const data _value, noconst data _state) :   eclrtl,volatile,entrypoint='rtlHashMd5Data';",
    "   data16 hashMd5Finish(noconst data _state) : eclrtl,volatile,entrypoint='rtlHashMd5Finish';",
    ...
    "   deserializeRaw(noconst data field, boolean o) : eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeRaw';",
    "   data deserializeDataX(boolean o) :  eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeDataX';",
    "   dataset deserializeDatasetX(boolean o) :    eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeDataX';",
    "   _linkcounted_ dictionary deserializeDictionaryX(boolean _deserializer, boolean _input) : eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeDictionaryX';",
    "   grouped dataset deserializeGroupedDatasetX(boolean o) : eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeDataX';",
    "   _linkcounted_ dataset deserializeRowsetX(boolean _deserializer, boolean _input) : eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeRowsetX';",
    "   _linkcounted_ grouped dataset deserializeGroupedRowsetX(boolean _deserializer, boolean _input) : eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeGroupedRowsetX';",
    "   varstring deserializeCStringX(boolean o) :  eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeCStringX';",
    "   string deserializeStringX(boolean o) :  eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeStringX';",
    "   qstring deserializeQStrX(boolean o) :   eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeQStrX';",
    "   unicode deserializeUnicodeX(boolean o) :    eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeUnicodeX';",
    "   utf8 deserializeUtf8X(boolean o) :  eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeUtf8X';",
    "   varunicode deserializeVUnicodeX(boolean o) :    eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeVUnicodeX';",
    "   _linkcounted_ row(dummyRecord) deserializeRow(boolean _deserializer, boolean _in) : eclrtl,volatile,include,entrypoint='rtlDeserializeBufferRow';",
    ...
    "   set of any deserializeSet(boolean o) :  eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeSet',newSet;",
    ...
    "   integer4 queryFailCode()    : gctxmethod,nomove,entrypoint='queryLastFailCode';",
    "   string getFailMessage(const varstring tag)  : gctxmethod,nomove,entrypoint='getLastFailMessage';",
    "   integer4 queryLocalFailCode(boolean e)  : eclrtl,nomove,include='eclrtl.hpp',library='eclrtl',entrypoint='rtlQueryLocalFailCode';",
    "   string getLocalFailMessage(boolean e, const varstring tag)  : eclrtl,nomove,include='eclrtl.hpp',library='eclrtl',entrypoint='rtlGetLocalFailMessage';",
    "   freeException(boolean e)    : eclrtl,include='eclrtl.hpp',library='eclrtl',entrypoint='rtlFreeException';",
    "   string getEventName()   : gctxmethod,nomove,entrypoint='getEventName';",
    "   string getEventExtra(const varstring tag)   : gctxmethod,nomove,entrypoint='getEventExtra';",
    ...
    "   boolean fileExists(const varstring lfn) : gctxmethod,volatile,entrypoint='fileExists';",  // volatile??
    "   varstring getExpandLogicalName(const varstring lfn) : ctxmethod,volatile,entrypoint='getExpandLogicalName';",  // volatile??
    ...
    "   unsigned4 getWorkflowId() : gctxmethod,nomove,entrypoint='getWorkflowId';",
    ...
    "   utf8 ctxGetRowXml(boolean _meta, const row _row, unsigned4 flags) : ctxmethod,pure,entrypoint='getRowXML';",
    "   utf8 ctxGetRowJson(boolean _meta, const row _row, unsigned4 flags) : ctxmethod,pure,entrypoint='getRowJSON';",
    ...
    "   _linkcounted_ row(dummyRecord) ensureCapacity(unsigned4 curSize, const varstring _fieldName) : omethod,voaltile,entrypoint='ensureCapacity',allocator=false;",
    ...
    "   unsigned integer4 getClusterSize() : ctxmethod,nomove,entrypoint='getNodes';",
    ...
    "   boolean newCountAggregateArg(boolean _meta) : include,pure,pseudoentrypoint='new CLibraryCountAggregateArg';",
    "   boolean newDegroupArg(boolean _meta) : include,pure,pseudoentrypoint='new CLibraryDegroupArg';",
    "   boolean newExistsAggregateArg(boolean _meta) : include,pure,pseudoentrypoint='new CLibraryExistsAggregateArg';",
    ...
    "   boolean newLibraryConstantRawIteratorArg(linkcounted dataset _x, boolean meta) : include,pure,pseudoentrypoint='new CLibraryConstantRawIteratorArg';",
    ...
    "   _linkcounted_ dataset linkdataset2linkdataset(_linkcounted_ dataset _x) : include,volatile,allocator(false),context,entrypoint='linkdataset2linkdataset';",

    "   dummyRecord rtlSerializeToBuilder(boolean _serializer, dummyRecord _in) : eclrtl,volatile,include,entrypoint='rtlSerializeToBuilder';",
    "   dummyRecord rtlDeserializeToBuilder(boolean _serializer, dummyRecord _in) : eclrtl,volatile,include,entrypoint='rtlDeserializeToBuilder';",
    "   _linkcounted_ row(dummyRecord) rtlDeserializeRow(boolean _deserializer, dummyRecord _in) : eclrtl,volatile,include,entrypoint='rtlDeserializeRow';",
    ...
    "   _linkcounted_ dataset linkRowset(_linkcounted_ dataset _x) : include,volatile,allocator(false),entrypoint='rtlLinkRowset';",

    "   _linkcounted_ dataset deserializeChildRowsetFromStream(boolean _deserializer, boolean _input) : eclrtl,volatile,include,entrypoint='rtlDeserializeChildRowset';",
    "   serializeChildRowsetToStream(boolean _output, boolean _serializer, _linkcounted_ dataset _x) : eclrtl,volatile,include,entrypoint='rtlSerializeChildRowset';",

    "   linkcounted dictionary deserializeChildDictionaryFromStream(boolean _deserializer, boolean _input) : eclrtl,volatile,include,entrypoint='rtlDeserializeChildDictionary';",
    "   linkcounted dictionary deserializeChildDictionaryFromDatasetFromStream(boolean _deserializer, boolean _hasher, boolean _input) : eclrtl,volatile,include,entrypoint='rtlDeserializeChildDictionaryFromDataset';",
    "   serializeChildDictionaryToStream(boolean _output, boolean _serializer, _linkcounted_ dictionary _x) : eclrtl,volatile,include,entrypoint='rtlSerializeChildDictionary';",
    "   serializeChildDictionaryToDatasetToStream(boolean _output, boolean _serializer, _linkcounted_ dictionary _x) : eclrtl,volatile,include,entrypoint='rtlSerializeChildDictionaryToDataset';",

    "   dictionary rtlSerializeDictionary(IOutputRowSerializer _ser, linkcounted dictionary x) : eclrtl,volatile,include,library='eclrtl',entrypoint='rtlSerializeDictionary';",
    "   dataset rtlSerializeDictionaryToDataset(IOutputRowSerializer _ser, linkcounted dictionary x) : eclrtl,volatile,include,library='eclrtl',entrypoint='rtlSerializeDictionaryToDataset';",
    "   linkcounted dictionary rtlDeserializeDictionary(IOutputRowDeserializer _ser, dictionary x) : eclrtl,volatile,include,library='eclrtl',entrypoint='rtlDeserializeDictionary';",
    "   linkcounted dictionary rtlDeserializeDictionaryFromDataset(IOutputRowDeserializer _ser, IHThorHashLookupInfo _hashInfo, dataset x) : eclrtl,volatile,include,library='eclrtl',entrypoint='rtlDeserializeDictionaryFromDataset';",
