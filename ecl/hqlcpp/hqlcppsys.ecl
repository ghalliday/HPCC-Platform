...
const char * cppSystemText[]  = {
    ...
    "   pack(string target, const string src) : eclrtl,volatile,library='eclrtl',entrypoint='rtlPack';",
    ...
    "   writeInt3(data1 src, unsigned4 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlWriteInt3';",
    "   writeInt5(data1 src, unsigned8 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlWriteInt5';",
    "   writeInt6(data1 src, unsigned8 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlWriteInt6';",
    "   writeInt7(data1 src, unsigned8 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlWriteInt7';",
    ...
    "   setPackedSigned(data1 src, integer8 value) :    eclrtl,volatile,library='eclrtl',entrypoint='rtlSetPackedSigned';",
    "   setPackedUnsigned(data1 src, unsigned8 value) : eclrtl,volatile,library='eclrtl',entrypoint='rtlSetPackedUnsigned';",
    ...
    "   DecAbs() :  bcd,volatile,library='nbcd',entrypoint='DecAbs';",
    "   DecAdd() :  bcd,volatile,library='nbcd',entrypoint='DecAdd';",
    ...
    "   integer4 DecCompareNull() : bcd,volatile,library='nbcd',entrypoint='DecCompareNull';",
    "   integer4 DecDistinct() :    bcd,volatile,library='nbcd',entrypoint='DecDistinct';",
    "   integer4 DecDistinctR() :   bcd,volatile,library='nbcd',entrypoint='DecDistinctR';",
    "   DecDivide() :   bcd,volatile,library='nbcd',entrypoint='DecDivide';",
    "   DecModulus() :  bcd,volatile,library='nbcd',entrypoint='DecModulus';",
    "   DecSub() :  bcd,volatile,library='nbcd',entrypoint='DecSub';",
    "   DecSubR() : bcd,voaltile,library='nbcd',entrypoint='DecSubR';",
    "   DecNegate() :   bcd,volatile,library='nbcd',entrypoint='DecNegate';",
    "   unsigned4 DecPopString(string tgt) :    bcd,volatile,library='nbcd',entrypoint='DecPopString';",
    "   DecPopVString(string tgt) : bcd,volatile,library='nbcd',entrypoint='DecPopCString';",
    "   varstring DecPopVStringX() :    bcd,volatile,library='nbcd',entrypoint='DecPopCStringX';",
    "   integer8 DecPopInt64() :    bcd,volatile,library='nbcd',entrypoint='DecPopInt64';",
    "   DecPopDecimal(data1 tgt,unsigned1 len,unsigned1 prec) : bcd,volatile,library='nbcd',entrypoint='DecPopDecimal';",
    "   DecPopUDecimal(data1 tgt,unsigned1 len,unsigned1 prec) : bcd,volatile,library='nbcd',entrypoint='DecPopUDecimal';",
    "   unsigned4 DecPopUlong() :   bcd,volatile,library='nbcd',entrypoint='DecPopUlong';",
    "   real8 DecPopReal() :    bcd,volatile,library='nbcd',entrypoint='DecPopReal';",
    "   DecPushString(const string tgt) :   bcd,volatile,library='nbcd',entrypoint='DecPushString';",
    "   DecPushCString(const varstring src) :   bcd,volatile,library='nbcd',entrypoint='DecPushCString';",
    "   DecPushInt64(integer8 src) :    bcd,volatile,library='nbcd',entrypoint='DecPushInt64';",
    "   DecPushLong(integer4 src) : bcd,volatile,library='nbcd',entrypoint='DecPushLong';",
    "   DecPushDecimal(const data1 src, unsigned1 declen, unsigned1 prec) : bcd,volatile,library='nbcd',entrypoint='DecPushDecimal';",
    "   DecPushUDecimal(const data1 src, unsigned1 declen, unsigned1 prec) : bcd,volatile,library='nbcd',entrypoint='DecPushUDecimal';",
    "   DecPushUInt64(unsigned8 src) :  bcd,volatile,library='nbcd',entrypoint='DecPushUInt64';",
    "   DecPushULong(unsigned4 src) :   bcd,volatile,library='nbcd',entrypoint='DecPushULong';",
    "   DecRound() :    bcd,volatile,library='nbcd',entrypoint='DecRound';",
    "   DecRoundUp() :  bcd,volatile,library='nbcd',entrypoint='DecRoundUp';",
    "   DecRoundTo(unsigned4 places) :  bcd,volatile,library='nbcd',entrypoint='DecRoundTo';",
    "   DecDup() :  bcd,volatile,library='nbcd',entrypoint='DecDup';",
    "   DecMul() :  bcd,volatile,library='nbcd',entrypoint='DecMul';",
    "   DecDivideR() :  bcd,volatile,library='nbcd',entrypoint='DecDivideR';",
    "   DecLongPower(integer4 pow) :    bcd,volatile,library='nbcd',entrypoint='DecLongPower';",
    "   DecPushReal(real8 d) :  bcd,volatile,library='nbcd',entrypoint='DecPushReal';",
    "   DecPushUtf8(utf8 d) :   bcd,volatile,library='nbcd',entrypoint='rtlDecPushUtf8';",
    "   DecTruncate() :    bcd,volatile,library='nbcd',entrypoint='DecTruncate';",
    "   DecTruncateAt(unsigned4 places) :  bcd,volatile,library='nbcd',entrypoint='DecTruncateAt';",
    "   DecSetPrecision(unsigned1 len, unsigned1 prec) : bcd,volatile,library='nbcd',entrypoint='DecSetPrecision';",
    "   integer4 DecPopLong() : bcd,volatile,library='nbcd',entrypoint='DecPopLong';",
    "   DecSwap() : bcd,volatile,library='nbcd',entrypoint='DecSwap';",
    "   DecUint4Power(unsigned4 pow) :  bcd,volatile,library='nbcd',entrypoint='DecUint4Power';",
    "   string DecPopStringX() :    bcd,volatile,library='nbcd',entrypoint='DecPopStringX';",
    "   DecLock() : bcd,volatile,library='nbcd',entrypoint='DecLock';",
    "   DecUnlock() :   bcd,volatile,library='nbcd',entrypoint='DecUnlock';",
    ...
    "   hashMd5Init(data _state) :  eclrtl,volatile,entrypoint='rtlHashMd5Init';",
    "   hashMd5Data(const data _value, data _state) :   eclrtl,volatile,entrypoint='rtlHashMd5Data';",
    "   data16 hashMd5Finish(data _state) : eclrtl,volatile,entrypoint='rtlHashMd5Finish';",

    "   boolean validReal(const data src) : eclrtl,pure,library='eclrtl',entrypoint='rtlIsValidReal';",

    "   deserializeRaw(data field, boolean o) : eclrtl,volatile,include='eclrtl.hpp',library='eclrtl',entrypoint='deserializeRaw';",
    ...
    "   _linkcounted_ row(dummyRecord) deserializeRow(boolean _allocator, boolean _deserializer, boolean _in) : eclrtl,volatile,include,entrypoint='rtlDeserializeBufferRow';",
    ...
    "   integer8 countRoxieDiskFile(unsigned4 id, boolean monitors) : ctxmethod,volatile,entrypoint='countDiskFile';",       // id is actually 8 bytes, for backward compatibility // ? volatile
    "   integer4 getRecoveringCount() : ctxmethod,nomove,entrypoint='getRecoveringCount';",
    ...
    "   _linkcounted_ row(dummyRecord) ensureCapacity(unsigned4 curSize, const varstring _fieldName) : omethod,volatile,entrypoint='ensureCapacity';", 
    ...
    "   unsigned4 rtlSerializeRow(unsigned4 _outLen, dummyRecord _out, boolean _serializer, dummyRecord _in) : eclrtl,volatile,include,entrypoint='rtlSerializeRow';",
    ...
    "   _linkcounted_ row(dummyRecord) rtlDeserializeRow(boolean _allocator, boolean _deserializer, dummyRecord _in) : eclrtl,volatile,include,entrypoint='rtlDeserializeRow';",
    ...
    "   _linkcounted_ dataset deserializerRowsetHelper(boolean _deserializer, boolean _input) : eclrtl,volatile,include,entrypoint='rtlDeserializeRowset';",
    ...
    "   row(dummyRecord) deserializerPeek(unsigned4 _maxSize) : omethod,volatile,entrypoint='peek';",
    "   unsigned4 deserializerBeginNested() : omethod,volatile,entrypoint='beginNested';",
    "   boolean deserializerFinishedNested(unsigned4 pos) : omethod,volatile,entrypoint='finishedNested';",
