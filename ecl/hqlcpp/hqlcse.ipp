...
public:
    ...
    unsigned minDepth = (unsigned)-1;        // REVIST: Not sure this actually works!  Currently unused.  May need a shortest path pointer instead.
...
private:
    ...
    bool calcedCommonLocation = false;       // Has the derived location information been calcualted for this node?
    bool moved = false;                      // Should this expression be evalauted in a different location in the graph?
