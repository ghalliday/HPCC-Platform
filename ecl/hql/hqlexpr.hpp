...
extern HQL_API IFileContents * createFileContentsFromText(StringBuffer & ownedContents, ISourcePath * sourcePath, bool isSigned, IHqlExpression * gpgSignature, timestamp_type ts);
