...
class CHThorRadicalDiskReadBaseActivity : public CHThorActivityBase, implements IThorDiskCallback, implements IIndexReadContext
{
protected:
    IHThorNewDiskReadBaseArg &helper;
    IHThorCompoundBaseArg & segHelper;
...
public:
    CHThorRadicalDiskReadBaseActivity(IAgentContext &agent, unsigned _activityId, unsigned _subgraphId, IHThorNewDiskReadBaseArg &_arg, IHThorCompoundBaseArg & _segHelper, ThorActivityKind _kind, EclGraph & _graph, IPropertyTree *node);
    ~CHThorRadicalDiskReadBaseActivity();
    IMPLEMENT_IINTERFACE
...
class CHThorRadicalDiskReadActivity : public CHThorRadicalDiskReadBaseActivity
{
    typedef CHThorRadicalDiskReadBaseActivity PARENT;
protected:
    IHThorNewDiskReadArg &helper;
...
public:
    CHThorRadicalDiskReadActivity(IAgentContext &agent, unsigned _activityId, unsigned _subgraphId, IHThorNewDiskReadArg &_arg, ThorActivityKind _kind, EclGraph & _graph, IPropertyTree *node);
