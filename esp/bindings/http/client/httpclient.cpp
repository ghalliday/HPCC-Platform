...
CHttpClient::CHttpClient(const char *proxy, const char* url) : m_url(url), m_proxy(proxy), m_disableKeepAlive(false), m_persistable(false), m_isPersistentSocket(false), m_numRequests(0)
{
