...
public:
    ...
    virtual unsigned getStringLen() { isUnknownLength(if(getSize())) return UNKNOWN_LENGTH; else return getSize()/2; }
    virtual unsigned getCardinality();
...
public:
    ...
    virtual unsigned getStringLen()             { return !isUnknownLength(length) ? length/2-1 : UNKNOWN_LENGTH; };
...
public:
    ...
    virtual unsigned getStringLen()             { return !isUnknownLength(length) ? length/4 : UNKNOWN_LENGTH; };
...
public:
    ...
    virtual unsigned getStringLen()             { return !isUnknownLength(length) ? length-1 : UNKNOWN_LENGTH; };
    virtual unsigned getDigits()                { return !isUnknownLength(length) ? length-1 : UNKNOWN_LENGTH; };
