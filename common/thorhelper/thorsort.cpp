...
class TbbParallelMergeSorter
{
    ...
    {
    public:
        BisectTask(TbbParallelMergeSorter & _sorter, void ** _rows, size_t _n, void ** _temp, unsigned _depth, CTask * _succ)
    ...
    {
    public:
        SubSortTask(TbbParallelMergeSorter & _sorter, CTask & _successor, void ** _rows, size_t _n, void ** _temp, unsigned _depth)
...
public:
    TbbParallelMergeSorter(void * * _rows, const ICompare & _compare)
